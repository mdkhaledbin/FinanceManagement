...
const SideBarEntries: React.FC<SideBarEntriesProps> = ({
  ...
  const handleNameBlur = () => {
    setIsEditing(false);
    // Here you would typically save the edited name to your database/state
      ...
      <div className="flex justify-between items-center mb-1 sm:mb-2 relative z-10">
        ...
        <div className="relative">
          <button
            ...
            className={`p-0.5 sm:p-1 rounded-md sm:rounded-lg transition-all duration-200 opacity-0 group-hover:opacity-100 
            ${
              theme === "dark"
          ...
          {isDropdownOpen && (
            <div
              ref={dropdownRef}
              className={`absolute left-[100%] mt-1 w-40 rounded-md shadow-lg z-[60] overflow-auto ${
                theme === "dark"
