...
const CTA = () => {
  ...
  return (
    <section id="cta" className={clsx(
      "py-20 md:py-28 transition-colors duration-300",
      theme === 'dark' ? "bg-gray-800" : "bg-gradient-to-r from-blue-600 to-indigo-700",
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <a 
          ...
          className={clsx(
            ...
            theme === 'dark' ? "bg-blue-500 text-white hover:bg-blue-600" : "bg-white text-blue-600 hover:bg-gray-100"
          )}
        >
          Get Started
        </a>
